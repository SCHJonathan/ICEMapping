...
class recommandationForm(forms.Form):
    young = forms.ChoiceField(choices=Preference, initial= '1')
    old = forms.ChoiceField(choices=Preference,initial= '1')
    middle = forms.ChoiceField(choices=Preference, initial= '1')
    white = forms.ChoiceField(choices=Preference, initial= '1')
    black = forms.ChoiceField(choices=Preference, initial= '1')
    asian = forms.ChoiceField(choices=Preference, initial= '1')
    otherrace = forms.ChoiceField(choices=Preference, initial= '1')
    population = forms.ChoiceField(choices=Preference, initial= '1')
    male = forms.ChoiceField(choices=Preference, initial= '1')
    female = forms.ChoiceField(choices=Preference, initial= '1')
